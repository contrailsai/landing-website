    ...
    return (
        <div className="relative min-h-screen">
            ...
            <div className="z-20 relative bg-gradient-to-b from-transparent to-white backdrop-blur-sm h-56">
                <h1 className="text-8xl font-semibold h-full px-20 flex justify-between items-center w-fit">Terms & Conditions</h1>
            </div>

            <div className="px-20 min-h-screen">
                terms and condtitions to follow should lie here
            </div>
